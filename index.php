...
if (isset($_REQUEST['keyword']) && $_REQUEST['keyword']<>""){
  ...
  $sql  = "SELECT t.iduser, t.username, t.password from tb_user t where t.iduser=t.iduser and t.username
  LIKE '%$keyword%' ORDER BY t.iduser asc";
}else{
    $reload = "index.php?pagination=true";
    $sql = "SELECT t.iduser, t.username, t.password from user t where t.iduser=t.iduser
            ORDER BY t.iduser asc";
      }
...
<div class="col-sm-9">
  <div class="panel panel-primary">
    ...
    <div>
      <!--mtnctl jika ada pencarian (tombol reset pencarian (kembali))-->
      <?php
             ...
             <tr>
              ...
              <td> <center>
                <a class="btn btn-sm btn-info" href="edit.php?iduser=<?php echo
                  $data['idtser'] ?>" title="Edit Data" ><span class="fa fa-edit"></span></a>
                  <a class="btn btn-sm btn-danger" href="delete.php?action=hapus&iduser=
                  <?php echo $data['iduser'] ?>" onClick="return confirm(' Data Yakin Mau
